...
def Decision_Tree(detph_argument = 2):
...
with ThreadPoolExecutor(max_workers = 20) as executor:
  task_list = executor.map(Decision_Tree, depth_list) #一次返回的是 test train accuracy
...
ax.set_title('Decision_Tree-Accuracy')
...
graph.write_pdf("White_WineTree.pdf")
